...
async def save_tutorial(client, message):
    ...
    try:
        ...
        return await message.reply_text(
            "<b>Command Incomplete!!\n\nuse like this -</b>\n\n<code>/set_caption https://telegram.me/OttSandhu</code>"
        )
...
async def set_tutorial_2(client, message):
    ...
    try:
        ...
        return await message.reply_text(
            "<b>ᴄᴏᴍᴍᴀɴᴅ ɪɴᴄᴏᴍᴘʟᴇᴛᴇ !!\n\nᴜꜱᴇ ʟɪᴋᴇ ᴛʜɪꜱ -</b>\n\n<code>/set_tutorial_2 https://telegram.dog/OttSandhu/2</code>"
        )
...
async def set_tutorial_3(client, message):
    ...
    try:
        ...
        return await message.reply_text(
            "<b>Command Incomplete!!\n\nuse like this -</b>\n\n<code>/set_tutorial https://telegram.dog/OttSandhu</code>"
        )
...
async def set_shortner(c, m):
    ...
    try:
        ...
        API = m.command[2]
        resp = requests.get(
            f"https://{URL}/api?api={API}&url=https://t.me/+G0zAirGK4600MTVl"
        ).json()
