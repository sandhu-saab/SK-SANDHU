    ...
    if len(message.command) == 3:
        try:
            ...
            await message.reply_text(
                "Please provide a valid number of codes to generate."
            )
            return
...
<b>𝙹𝚞𝚜𝚝 𝚌𝚕𝚒𝚌𝚔 𝚝𝚑𝚎 𝚊𝚋𝚘𝚟𝚎 𝚌𝚘𝚍𝚎 𝚝𝚘 𝚌𝚘𝚙𝚢 𝚊𝚗𝚍 𝚝𝚑𝚎𝚗 𝚜𝚎𝚗𝚍 𝚝𝚑𝚊𝚝 𝚌𝚘𝚍𝚎 𝚝𝚘 𝚝𝚑𝚎 𝙱𝚘𝚝, 𝚝𝚑𝚊𝚝'𝚜 𝚒𝚝 🔥</b>"""
        ...
        keyboard = InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("❕ Any Query ❕", url="https://t.me/Baii_Ji")],
            ]
        )
            ...
            try:
                ...
                if seconds > 0:
                    ...
                    if current_expiry and current_expiry > now_aware:
                        expiry_str_in_ist = current_expiry.astimezone(
                    ...
                    expiry_str_in_ist = expiry_time.astimezone(
                        pytz.timezone("Asia/Kolkata")
                    ).strftime("%d-%m-%Y\n⏱️ Expiry Time: %I:%M:%S %p")
                ...
                await message.reply_text(
                    f"An error occurred while redeeming the code: {e}"
                )
        else:
